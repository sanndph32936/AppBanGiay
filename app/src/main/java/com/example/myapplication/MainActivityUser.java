...
import com.example.myapplication.fragment.GioiThieuFragment;
import com.example.myapplication.fragment.HoaDonFragment;
import com.example.myapplication.fragment.LichSuMuaHangFragment;
import com.example.myapplication.fragment.ThongTinNguoiDungFragment;
import com.example.myapplication.fragment.TopSanPhamFragment;
...
public class MainActivityUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activityuser_main);

        progressDialog = new ProgressDialog(this);

        drawerLayout = findViewById(R.id.layout_all);
        toolbar = findViewById(R.id.jluser_toolbar);
        navigationView = findViewById(R.id.main_navigation_view01);
        bottomNavigationView = findViewById(R.id.jluser_btton_nav);
        ...
        ActionBarDrawerToggle  toggle = new ActionBarDrawerToggle(MainActivityUser.this , drawerLayout , toolbar , R.string.open,R.string.close);
    ...
    private void callFragment (Fragment fragment){
        ...
        manager.replace(R.id.jluser_fragment,fragment).commit();
        drawerLayout.close();
        progressDialog.dismiss();
    }
    ...
    private void setThongTin (){
        ...
        reference.child("NguoiDung").child(user.getUid()).child("anh").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.getValue() != null){
                    Glide.with(MainActivityUser.this).load(snapshot.getValue().toString()).into(imgAvt);
                }
            }
...
public void Logout(){
    ...
    builder.setPositiveButton("Đồng ý", new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            Intent intent = new Intent(MainActivityUser.this,DangNhap.class);
