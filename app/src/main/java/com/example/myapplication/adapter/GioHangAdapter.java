...
import com.example.myapplication.models.GioHang;
...
public class GioHangAdapter extends RecyclerView.Adapter<GioHangAdapter.HolderGioHangAdapter>{
    ...
    @NonNull
    @Override
    public HolderGioHangAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.gio_hang_item,parent,false);

        return new HolderGioHangAdapter(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HolderGioHangAdapter holder, @SuppressLint("RecyclerView") int position) {
        Glide.with(context)
